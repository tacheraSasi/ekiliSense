...
$teacher_id = 0;
if(isset($_GET['id'])&&isset($_GET['suid'])){
$teacher_id = $_GET['id'];
}else{
header("location:../404");
}
$school_uid = isset($_SESSION['School_uid'])?$_SESSION['School_uid']:$_GET['suid'];
...
$get_teacher = mysqli_query($conn, "SELECT * FROM teachers WHERE school_unique_id = '$school_uid' AND teacher_id = '$teacher_id'");
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Contact</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <h5 class="card-title">Teacher's Details</h5>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Send email to <?=$teacher['teacher_fullname'];?></label>
                    ...
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Call</label>
                      <div class="col-md-8 col-lg-9">
                        <a href="tel:<?=$teacher['teacher_active_phone'];?> " class="btn btn-secondary">Call</a>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">ekiliConvo</label>
                      <div class="col-md-8 col-lg-9">
                        <button class="btn btn-success">Create a convo</button>
                      </div>
                    </div>
