                ...
                <div class="col-md-6">
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td><code><?= $school_uid ?></code></td>
                    </tr>
                    <tr>
                      <td><strong>Admin Email:</strong></td>
                      <td><?= $school_data['Admin_email'] ?></td>
                    </tr>
                    <tr>
                      <td><strong>Registration Date:</strong></td>
                      <td><?= date('M d, Y', strtotime($school_data['created_at'])) ?></td>
                    </tr>
                  </table>
                </div>
                <div class="col-md-6">
                  <table class="table">
                    ...
                    <tr>
                      <td><strong>Logins (30 days):</strong></td>
                      <td><?= $login_count['count'] ?></td>
                    </tr>
                    <tr>
                      <td><strong>Active Sessions:</strong></td>
                      <td><?= $sessions_count['count'] ?></td>
                    </tr>
                    <tr>
                      <td><strong>Total Users:</strong></td>
                      <td><?= $students_count + $teachers_count ?></td>
                    </tr>
                  </table>
                </div>
              </div>
