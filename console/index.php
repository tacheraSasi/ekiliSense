...
<head>
    ...
    <meta name="description"
        content="The ekiliSense Console for efficient school management. Utilize advanced tools to automate, track, and optimize educational operations. Join the future of smart school administration with ekiliSense.">
    <meta name="keywords"
        content="ekiliSense, ekili, ekilie, ekilisense, school management system, education automation, school console, smart management, school operations, edtech, education technology, academic management, ekili education, ekili school, ekili management">
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <button id="ekilie-ai-btn"
                        class=" nav-link nav-icon d-flex align-items-center justify-content-center"
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $school['School_name']?></span>
                    </a><!-- End Profile Iamge Icon -->

                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6 id="school-name-h6"><?php echo $school['School_name']?></h6>
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                href="logout.php?ref=<?php echo $school_uid?>">
                    ...
                    <div class="row">
                        <div class="manage-btn-container">
                            <div class="manage-content">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#add-teacher-modal"
                                    class="manage-btn" style="background-color: cadetblue;">
                                    <i class="bi bi-people"></i>
                                    Add teacher
                                </button>

                                <!-- <button type="button" data-bs-toggle="modal" data-bs-target="#import-teachers-modal"
                                    class="manage-btn" style="background-color: #4A90E2;">
                                    <i class="bi bi-file-earmark-spreadsheet"></i>
                                    Import Teachers
                                </button> -->

                                <button type="button" data-bs-toggle="modal" data-bs-target="#add-class-modal"
                                    class="manage-btn" style="background-color: #a0695f;">
                                    <i class="bi bi-buildings"></i>
                                    Create class
                                </button>

                                <button type="button" data-bs-toggle="modal" data-bs-target="#add-class-teacher-modal"
                                    class="manage-btn" style="background-color: #64a05f;">
                                    <i class="bi bi-person"></i>
                                    Add Class teacher
                                </button>
 ...
 -->
                                        ...
                                        document.addEventListener("DOMContentLoaded", () => {
                                            new Chart(document.querySelector('#barChart'), {
                                                ...
                                                data: {
                                                    ...
                                                    datasets: [{
                                                        label: 'Users',
                                                        data: [<?php echo $teachers_count?>,
                                                            <?php echo $students_count?>,
                                                            <?php echo $students_count / 2?>
                                                        ],
                                                        backgroundColor: [
                                                            'rgba(255, 99, 132, 0.2)',
                ...
                <div class="col-lg-4">
                    ...
                    <div class="alert alert-dark bg-dark border-0 text-light alert-dismissible fade show" role="alert">
                        ...
                        <p class="mb-0">
                            <!-- <i class="bi bi-rocket"></i> -->🚀 Transform your school's management with ekiliSense!
                        </p>
                ...
                <div class="modal-dialog modal-xl ">
                    ...
                    justify-content: flex-start;">
                                            <div class="logo-container">
                                                <img src="https://www.ekilie.com/assets/img/favicon.jpeg" alt=""
                                                    class="logo">
                                ...
                                <div class="right">
                                    ...
                                    <form class="modal-form" id="teacher" action="#" method="POST"
                        ...
                        border-radius:8px;">
                                        ...
                                        <div class=" field input">
                                            <input style="width: 100%;" type="tel" name="mobile"
                                                placeholder="Teacher's mobile" required>
                                        </div>
                ...
                <div class="modal-dialog modal-xl ">
                    ...
                    justify-content: flex-start;">
                                ...
                                <div class="right">
                                    ...
                                    <form class="modal-form" id="import-teachers-form"
                                        action="server/import-teachers.php" method="POST" enctype="multipart/form-data"
                                        autocomplete="off">
                                        <div class="error-text" style="
                          background-color: rgba(243, 89, 89, 0.562);
                          border:solid 1px rgba(243, 89, 89, 0.822);
                          ...
                          display:none;">
                                        ...
                                        <div class="field input">
                                            <label for="teacher-file"
                                                style="color: #fff; margin-bottom: 8px; display: block;">
                                                Select CSV or Excel file (.csv, .xls, .xlsx)
                                            </label>
                                            <input
                                                style="width: 100%; background-color: #444; border: 1px solid #666; color: #fff; padding: 10px; border-radius: 4px;"
                                                type="file" name="teacher_file" id="teacher-file"
                                        ...
                                        <div class="field" style="margin-top: 15px;">
                                            <label style="color: #fff; margin-bottom: 8px; display: block;">
                                                <input type="checkbox" id="validate-emails" name="validate_emails"
                                                    value="1" checked style="margin-right: 8px;">
                                                Validate email addresses
                                            </label>
                                            <label style="color: #fff; margin-bottom: 8px; display: block;">
                                                <input type="checkbox" id="skip-duplicates" name="skip_duplicates"
                                                    value="1" checked style="margin-right: 8px;">
                                                Skip duplicate email addresses
                                            </label>
                                            <label style="color: #fff; margin-bottom: 8px; display: block;">
                                                <input type="checkbox" id="send-invites" name="send_invites" value="1"
                                        ...
                                        <div class="input-container field button">
                                            <button id="import-submit" title="import teachers"
                ...
                <div class="modal-dialog modal-xl ">
                    ...
                    justify-content: flex-start;">
                                ...
                                <div class="right">
                                    ...
                                    <form class="modal-form" id="class-teacher" action="#" method="POST"
                                        enctype="multipart/form-data" autocomplete="off">
                                        <div class="error-text" style="
                        background-color: rgba(243, 89, 89, 0.562);
                        border:solid 1px rgba(243, 89, 89, 0.822);
                ...
                <div class="modal-dialog modal-xl ">
                    ...
                    justify-content: flex-start;">
                                ...
                                <div class="right">
                                    ...
                                    <form class="modal-form" id="class" action="#" method="POST"
                                        enctype="multipart/form-data" autocomplete="off">
                                        <div class="error-text" style="
                        background-color: rgba(243, 89, 89, 0.562);
                        border:solid 1px rgba(243, 89, 89, 0.822);
                        ...
                        border-radius:8px;">
                                        ...
                                        <div class=" field input">
                                            <input style="width: 100%;" type="text" name="class-name"
                                                placeholder="Write the class name here " required>
                                        </div>
                ...
                <div class="modal-dialog modal-xl ">
                    ...
                    justify-content: flex-start;">
                                ...
                                <div class="right">
                                    ...
                                    <form class="modal-form" id="upgrade" action="#" method="POST"
                                        enctype="multipart/form-data" autocomplete="off"
                                        style="max-width: 400px; margin: 0 auto; padding: 20px; background-color: #1c1c1e; border-radius: 10px; color: #fff;text-align:left">
                                        <input type="hidden" name="school" value="<?php echo $school_uid?>">
                                        <h3 style="text-align: center; margin-bottom: 10px; color: #fff;">10000
                                            Tsh/month</h3>
                                        ...
                                        <ul class="list-group"
                                            ...
                                            <li class="list-group-item"
                                                ...
                                                <i class="bi bi-check-circle-fill"
                                                    style="color: var(--btn-light-bg);"></i> 100 emails and 20 sms to
                                                all you users monthly
                                            ...
                                            <li class="list-group-item"
                                                style="background-color: transparent; color: #fff; border: none;">
                                                <i class="bi bi-check-circle-fill"
                                                    style="color: var(--btn-light-bg);"></i> Priority Customer Support
                                            </li>
                                            <li class="list-group-item"
                                                style="background-color: transparent; color: #fff; border: none;">
                                                <i class="bi bi-check-circle-fill"
                                                    style="color: var(--btn-light-bg);"></i> Reliable AI integration
                                            </li>
                                            <li class="list-group-item"
                                                style="background-color: transparent; color: #fff; border: none;">
                                                <i class="bi bi-check-circle-fill"
                                                    style="color: var(--btn-light-bg);"></i> Customizable Dashboard &
                                                Unlimited ekiliSense features
                                            </li>
                                        </ul>

                                        <!-- Button -->
                                        <div class="input-container field button text-center">
                                            <button id="submit" title="Upgrade to Premium" type="submit"
        ...
        if (importForm) {
            importForm.addEventListener('submit', function(e) {
                ...
                fetch('server/import-teachers.php', {
                    ...
                    .catch(error => {
                        errorDiv.innerHTML =
                            'An error occurred while importing teachers. Please try again.';
                        errorDiv.style.display = 'block';
