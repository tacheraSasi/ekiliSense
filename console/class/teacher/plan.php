...
if (isset($_GET["ref"])) {
    ...
    $ref = $_GET["ref"];
    $get_plan = mysqli_query(
        $conn,
        "SELECT * FROM plans WHERE school_uid = '$school_uid' AND uid = '$ref'"
    );
    if (mysqli_num_rows($get_plan) > 0) {
        ...
        #text color
        $textColor =
            $bg_color == "bg-info" || $bg_color == "bg-warning"
                ? "text-dark"
                : "";
    } else {
        $isValidUrl = true;
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content card">
                ...
                <form class="modal-footer" method="post" >
                  <input type="hidden" name="plan-ref" value="<?= $_GET[
                      "ref"
                  ] ?>">
