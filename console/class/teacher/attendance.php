  ...
  <main id="main" class="main">
    ...
    style="margin:1rem auto;">
      <div class="pagetitle" style="display:inline-block">
        <h1 style="display:inline-block">Attendance <i class="bi bi-arrow-right-short"> </i> <?= $class_info[
            "Class_name"
        ] ?></h1>
      </div><!-- End Page Title -->
                  ...
                  <tbody>
                    ...
                    while ($row_std = mysqli_fetch_array($students)) {
                      ...
                      student_id = '$student_id' and attendance_date = '$now'"
                        ...
                        <tr>
                          <td><?= $n ?></td>
                          <td><?= $row_std["student_first_name"] .
                              " " .
                              $row_std["student_last_name"] ?></td>
                          <td>
                            <form method="post" class="attendance-mark" id="<?= $row_std[
                                "student_id"
                            ] ?>">
                              <input type="hidden" name="student" value="<?= $row_std[
                                  "student_id"
                              ] ?>">
                              <input type="hidden" name="class" value="<?= $row_std[
                                  "class_id"
                              ] ?>">
