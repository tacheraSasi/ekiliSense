...
<head>
  ...
  <title>ekiliSense | <?=$school['School_name']?> | Perfomance</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1><i class="bi bi-rocket-takeoff"></i> Perfomance & Analytics</h1>
    ...
    <section class="section">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Stuff Work Attendance</h5>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Student Class Attendance</h5>
